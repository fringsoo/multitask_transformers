...
from multitask_transformers.scripts.modeling_bert_multitask import (
    ...
    BertADTaskClassification,
    BertSNSTaskClassification,
    BertForSarcClassification
    )
...
MODEL_AD_TASK_CLASSIFICATION_MAPPING = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForMultitaskSequenceClassification),
        (BertConfig, BertADTaskClassification),
    ]
)

MODEL_SNS_TASK_CLASSIFICATION_MAPPING = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForMultitaskSequenceClassification),
        (BertConfig, BertSNSTaskClassification),
    ]
)

MODEL_FOR_SARC_CLASSIFICATION_MAPPING = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForMultitaskSequenceClassification),
        (BertConfig, BertForSarcClassification),
    ]
)
...
class AutoModelForADTaskClassification:
    r"""
        :class:`~transformers.AutoModelForSequenceClassification` is a generic model class
        that will be instantiated as one of the sequence classification model classes of the library
        when created with the `AutoModelForSequenceClassification.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForSequenceClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_AD_TASK_CLASSIFICATION_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        raise ValueError(
            "Unrecognized configuration class {} for this kind of AutoModel: {}.\n"
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_AD_TASK_CLASSIFICATION_MAPPING.keys()),
            )
        )
...
class AutoModelForSNSTaskClassification:
    r"""
        :class:`~transformers.AutoModelForSequenceClassification` is a generic model class
        that will be instantiated as one of the sequence classification model classes of the library
        when created with the `AutoModelForSequenceClassification.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForSequenceClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_SNS_TASK_CLASSIFICATION_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        raise ValueError(
            "Unrecognized configuration class {} for this kind of AutoModel: {}.\n"
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_SNS_TASK_CLASSIFICATION_MAPPING.keys()),
            )
        )
...
class AutoModelForSarcClassification:
    r"""
        :class:`~transformers.AutoModelForSequenceClassification` is a generic model class
        that will be instantiated as one of the sequence classification model classes of the library
        when created with the `AutoModelForSequenceClassification.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForSequenceClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_SARC_CLASSIFICATION_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        raise ValueError(
            "Unrecognized configuration class {} for this kind of AutoModel: {}.\n"
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_SARC_CLASSIFICATION_MAPPING.keys()),
            )
        )
